...
// ReadJSON tries to read the body of  request and converts it from json into a go data variable
...
// ErrorJSON takes an error, and optionally a status code , and generates and sends an JSON error message
...
// PushJSONToRemote posts arbitray data to some URL as JSON and returns the response, status code, and error if any
