...
var jsonTests = []struct {
	...
	{name: "badly formated json", json: `{"foo": }`, errorExpected: true, maxSize: 1024, allowUnkown: false},
	{name: "incorrect type", json: `{"foo": 5}`, errorExpected: true, maxSize: 1024, allowUnkown: false},
	{name: "two json files", json: `{"foo": "bar"}{"alpha": "beta"}`, errorExpected: true, maxSize: 1024, allowUnkown: false},
...
func TestTools_ReadJSON(t *testing.T) {
	...
	for _, e := range jsonTests {
		...
		// declare variable to read decoded json into
